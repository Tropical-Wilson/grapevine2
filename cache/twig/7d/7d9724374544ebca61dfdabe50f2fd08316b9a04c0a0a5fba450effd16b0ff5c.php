...
class __TwigTemplate_d625223ae79ad6685e75f619dab9bb283c9ad57712173cb7196ddc9d72cb78fd extends Twig_Template
{
...
($context["segment"] ?? null), "subtype", array())) . ".html.twig"), 2 => "@nucleus/content/missing.html.twig"), "@nucleus/content/particle.html.twig", 15)->display($context);
    ...
    ";
            // line 21
            $context["classes"] = trim(((( !($context["inContent"] ?? null)) ? ("g-content g-particle ") : ("g-particle ")) . twig_join_filter($this->getAttribute(($context["segment"] ?? null), "classes", array()), " ")));
            // line 22
            echo "    ";
            if (trim(($context["html"] ?? null))) {
                // line 23
                echo "    <div class=\"";
...
{% endtry %}
", "@nucleus/content/particle.html.twig", "/Users/webdev/HTTP/grapevine-v3/user/plugins/gantry5/engines/nucleus/templates/content/particle.html.twig");
    }
}
