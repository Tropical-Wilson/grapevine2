...
class __TwigTemplate_809585a6728e6e13f40a20000573d5e0419ec0808f0d0f72ecd3c278d22c2b4b extends Twig_Template
{
    ...
    protected function doDisplay(array $context, array $blocks = array())
    {
        ...
        if ( !(null === ($context["boxed"] ?? null))) {
            // line 7
            echo "    ";
            $context["boxed"] = (((trim(($context["boxed"] ?? null)) == "")) ? ($this->getAttribute($this->getAttribute($this->getAttribute($this->getAttribute($this->getAttribute(($context["gantry"] ?? null), "config", array()), "page", array()), "body", array()), "layout", array()), "sections", array())) : (($context["boxed"] ?? null)));
        }
        // line 9
        echo "
";
...
";
        // line 26
        if (($this->getAttribute($this->getAttribute(($context["segment"] ?? null), "attributes", array()), "sticky", array()) || trim(($context["html"] ?? null)))) {
            // line 27
            echo "    ";
    ...
    ";
            ...
            // line 35
            echo "    ";
            $context["attr_class"] = ((($context["attr_class"] ?? null)) ? (((" class=\"" . trim(($context["attr_class"] ?? null))) . "\"")) : (""));
            // line 36
            echo "    <";
...
{% if segment.attributes.sticky or html|trim %}
    ...
    {% endif %}
{% endif %}
", "@nucleus/layout/section.html.twig", "/Users/webdev/HTTP/grapevine-v3/user/plugins/gantry5/engines/nucleus/templates/layout/section.html.twig");
    }
}
