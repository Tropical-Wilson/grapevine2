...
class __TwigTemplate_b63b805df1d57bf30b5c211507b9701f0a1e13bc340da968084f86e081f16dd8 extends Twig_Template
{
    ...
    {
        // line 3
        $context["start_date"] = ((twig_in_filter(trim($this->getAttribute($this->getAttribute(($context["particle"] ?? null), "date", array()), "start", array())), array(0 => "now", 1 => ""))) ? (twig_date_format_filter($this->env, "now", "Y")) : (twig_escape_filter($this->env, $this->getAttribute($this->getAttribute(($context["particle"] ?? null), "date", array()), "start", array()))));
        // line 4
        $context["end_date"] = ((twig_in_filter(trim($this->getAttribute($this->getAttribute(($context["particle"] ?? null), "date", array()), "end", array())), array(0 => "now", 1 => ""))) ? (twig_date_format_filter($this->env, "now", "Y")) : (twig_escape_filter($this->env, $this->getAttribute($this->getAttribute(($context["particle"] ?? null), "date", array()), "end", array()))));
        // line 1
...
{% endblock %}
", "@particles/copyright.html.twig", "/Users/webdev/HTTP/grapevine-v3/user/themes/g5_helium/particles/copyright.html.twig");
    }
}
